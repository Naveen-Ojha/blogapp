...
const DrawerNavigator = () => {
  ...
  return (
    <>
      <Drawer.Navigator>
        <Drawer.Screen name="Fashion Sootra" component={BottomTabNavigator} />
        {cateKeys.map((cate) => {
          return (
            <Drawer.Screen
              key={categoryName[cate]["TermSlug"]}
              name={categoryName[cate]["TermName"]}
              initialParams={{ slug: categoryName[cate]["TermSlug"] }}
